...
exports.viewCall = void 0;
const near_api_js_1 = require("near-api-js");
const viewCall = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const veiwFunction = yield contract.account.viewFunction({
        ...
        const callFunction = yield contract.account.functionCall({
            contractId: 'ico.akinyemisaheedwale2.testnet',
            methodName: 'invest',
            args: { "amount": 2000 },
            attachedDeposit: near_api_js_1.utils.format.parseNearAmount("0.03")
        });
